...
object DBConf {
  ...
  implicit val passwordConfigDec: Decoder[DBPassword] = deriveDecoder[DBPassword]
  implicit val userNameConfigDec: Decoder[DBUserName] = deriveDecoder[DBUserName]
  implicit val userConfigDec: Decoder[DBUser]         = deriveDecoder[DBUser]
  implicit val poolConfigDec: Decoder[DBConnections]  = deriveDecoder[DBConnections]
